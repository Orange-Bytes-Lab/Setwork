...
class HomeViewModelFactory (
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return HomeViewModel(dateGenerator,todoRepository,categoryRepository,noteRepository,loadInitialDateUseCase,loadNextDatesSetUseCase, loadPreviousDatesSetUseCase) as T
    }
}